...
| 2 | **Knowledge Scout** | Jira, Confluence, Google Drive, AWS Docs | `agent-scout.md` |
| 3 | **Historian** | Exploración del repo actual | `agent-historian.md` |
| 4 | **Test Engineer** | Tests E2E, Playwright, CLI | `agent-tech-guardian.md` |
| 5 | **Platform Analyst** | Repos externos de plataforma | `agent-github-repos.md` |
| 6 | **PO-Agile** | Historias de Usuario (INVEST, Gherkin) | `agent-po-agile.md` |
| 7 | **Doc Updater** | Documentación viva | `agent-doc-updater.md` |
| 8 | **Cloud SRE** | Incidentes: Datadog + AWS + GitHub + Jira | `agent-cloud-sre.md` |
| 9 | **Clarity Behavior** | UX en producción (Microsoft Clarity) | `agent-clarity-behavior.md` |
| 10 | **Prompt Engineer** | Diseño de prompts avanzados | `agent-prompt-engineer.md` |
| 11 | **Angular Developer** | Código Angular + Figma | `agent-angular-developer.md` |
| 12 | **Cloud Infra** | Auditoría infraestructura AWS (FinOps) | `agent-cloud-infra.md` |
| 13 | **AI Agent Ops** | Prompts en producción (Langfuse) + ADK | `agent-prompt-ops.md` |
| 14 | **BI Strategist** | Power BI, Looker, KPIs de negocio | `agent-bi-strategist.md` |
| 15 | **Report Builder** | Reportes HTML ejecutivos | `agent-report-builder.md` |
| 16 | **Comms Analyst** | Comunicaciones Infobip (WhatsApp, SMS, Email) | `agent-comms-analyst.md` |
| 17 | **Harness Engineer** | Infraestructura interna del enjambre (scripts, hooks, telemetry) | `agent-harness-engineer.md` |
| 18 | **Auditor** | Calidad del trabajo de agentes (Gemini) | `agent-auditor.md` |
...
| **ralph-loop** | `.kiro/skills/ralph-loop/` | Ejecución autónoma de specs con fresh context por iteración |

---

## Hooks de Agentes (19 hooks en `.kiro/hooks/`)
...
| Hook | Propósito |
|------|-----------|
| `atlassian-write-guard` | Solo Scout, PO-Agile, Cloud SRE y Cloud Infra pueden ESCRIBIR en Jira/Confluence |
| `clarity-mcp-guard` | Solo Clarity Behavior usa MCP Clarity |
| `datadog-mcp-guard` | Solo Cloud SRE usa MCP Datadog |
| `aws-api-guard` | Solo Cloud SRE y Cloud Infra usan MCP AWS API |
| `chrome-devtools-guard` | Solo Test Engineer (skill prueba) usa Chrome DevTools MCP |
| `playwright-mcp-guard` | Solo Test Engineer (skill prueba) usa Playwright MCP |
| `github-mcp-guard` | Solo Platform Analyst y Cloud SRE usan MCP GitHub |
| `google-drive-guard` | Solo Knowledge Scout usa MCP Google Drive |
| `drawio-mcp-guard` | Solo Doc Updater (skill diagramas-drawio) usa MCP Draw.io |
| `langfuse-mcp-guard` | Solo AI Agent Ops usa MCP Langfuse |
| `bi-mcp-guard` | Solo BI Strategist usa MCPs Power BI y Looker |
| `infobip-mcp-guard` | Solo Comms Analyst usa MCPs de Infobip |
...
| `agent-scout.md` | fileMatch (plans, platforms) | Knowledge Scout: fuentes documentales |
| `agent-historian.md` | fileMatch (código, scripts) | Historian: contexto e impacto |
| `agent-tech-guardian.md` | fileMatch (tests) | Test Engineer: QA Specialist |
| `agent-github-repos.md` | fileMatch (platforms) | Platform Analyst: repos externos |
| `agent-po-agile.md` | fileMatch (plans, docs) | PO-Agile: Historias de Usuario |
| `agent-doc-updater.md` | fileMatch (código, docs) | Doc Updater: documentación viva |
| `agent-cloud-sre.md` | fileMatch (platforms, infra) | Cloud SRE: incidentes y observabilidad |
| `agent-clarity-behavior.md` | fileMatch (docs, ux) | Clarity Behavior: análisis UX |
| `agent-prompt-engineer.md` | manual | Prompt Engineer: diseño de prompts |
| `agent-angular-developer.md` | fileMatch (ts, html, scss) | Angular Developer: código Angular |
| `agent-cloud-infra.md` | fileMatch (infra, platforms) | Cloud Infra: auditoría AWS |
| `agent-prompt-ops.md` | fileMatch (prompts, langfuse) | AI Agent Ops: lifecycle de agentes |
| `agent-bi-strategist.md` | manual | BI Strategist: inteligencia de negocios |
| `agent-report-builder.md` | manual | Report Builder: reportes HTML |
| `agent-comms-analyst.md` | fileMatch (infobip, whatsapp, comms) | Comms Analyst: comunicaciones Infobip |
| `agent-harness-engineer.md` | fileMatch (scripts, hooks, settings, tools) | Harness Engineer: infraestructura del enjambre |
| `agent-auditor.md` | always | Auditor: calidad y juicios (Gemini) |
...
| `npm run harness:report` | Reporte de telemetry del harness (últimos 7 días) |
| `npm run harness:analyze` | Analiza fallos y genera propuestas de mejora |
| `npm run harness:dashboard` | Genera dashboard HTML del harness → `docs/harness-dashboard.html` |
| `npm run ralph -- 15 .kiro/specs/feature` | Ralph Loop: ejecución autónoma (15 iteraciones) |
| `npm run ralph:once -- .kiro/specs/feature` | Una iteración del Ralph Loop (debug) |
