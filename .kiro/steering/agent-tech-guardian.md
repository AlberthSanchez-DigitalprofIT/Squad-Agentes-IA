...
---
# AGENTE TEST ENGINEER (Calidad y Testing)
...
Al ejecutar auditorías (PageSpeed, Lighthouse, tests E2E) que generen hallazgos medibles, el Test Engineer **debe capturar screenshots** como evidencia:
...
- Orquestador: `.kiro/steering/00-swarm-orchestrator.md` (Test Engineer).
